...
public class controller {
    ...
    @PutMapping("/update")
    public ResponseEntity<imsProgGui> updateObject(@RequestBody imsProgGui[] objects){
        LOG.info("PUT /update");
        try {
            imsProgGui result = ImsProgGuiDao.updateImsProgGui(objects);
            if (result != null){
                return new ResponseEntity<imsProgGui>(result, HttpStatus.OK);
            } else {
    ...
    public ResponseEntity<imsProgGui> deleteObject(@RequestBody imsProgGui object){
        LOG.info("DELETE /delete");
        try {
            imsProgGui result = ImsProgGuiDao.deleteImsProgGui(object);
            if (result != null){
                return new ResponseEntity<imsProgGui>(result, HttpStatus.OK );
            } else {
                return new ResponseEntity<>(HttpStatus.NOT_FOUND);
